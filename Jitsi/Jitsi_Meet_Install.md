...
### Edit jicofo sip-communicator in `/etc/jitsi/videobridge/sip-communicator.properties`
```
org.ice4j.ice.harvest.DISABLE_AWS_HARVESTER=true
org.ice4j.ice.harvest.NAT_HARVESTER_LOCAL_ADDRESS=X.X.X.X
org.ice4j.ice.harvest.NAT_HARVESTER_PUBLIC_ADDRESS=X.X.X.X
org.ice4j.ice.harvest.STUN_MAPPING_HARVESTER_ADDRESSES=jitmeet.example.com:4446
```
